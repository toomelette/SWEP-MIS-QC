    ...
    public function rules(){
        return [
           ...
           'funds' => 'required|string',
            ...
            'applied_projects.*.pap_code' => 'required',
            'applied_projects.*.mooe' => 'required_without:applied_projects.*.co|prohibited_unless:applied_projects.*.co,null',
            'applied_projects.*.co' => 'required_without:applied_projects.*.mooe|prohibited_unless:applied_projects.*.mooe,null',
        ];
    }
