...
class ORSService
{
    ...
    public function findBySlug($slug){
        $ors = ORS::query()->with(['accountEntries.chartOfAccount','accountEntries.responsibilityCenter.description','projectsApplied.responsibilityCenter.description','dvEntries.chartOfAccount'])->where('slug','=',$slug)->first();
