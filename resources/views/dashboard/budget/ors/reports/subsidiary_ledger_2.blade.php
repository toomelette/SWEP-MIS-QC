<div class="box box-sm box-default box-solid">
    ...
    <div class="box-body" style="">
        <form class="generate_report_form" id="subsidiary_ledger_2_form" url="{{route('dashboard.ors.report_generate','subsidiary_ledger_2')}}" target="#subsidiary_ledger_2_frame">
            <div class="row">
        ...
        <div class="frame-container">
            ...
            <div class="bs-example frame-inner-container" style="display:none;">
                ...
                <div class="embed-responsive embed-responsive-16by9" style="height: 1019.938px;">
                    <iframe id="subsidiary_ledger_2_frame" class="embed-responsive-item" src=""></iframe>
                </div>
            </div>
        </div>
    </div>
