<div class="box box-sm box-default box-solid">
    <div class="box-header with-border">
        <p class="no-margin">Budget Proposal (Monitoring)</p>
    </div>

    <div class="box-body" style="">
        <form class="generate_report_form" id="budget_proposal_monitoring_form" url="{{route('dashboard.ors.report_generate','budget_proposal_monitoring')}}" target="#budget_proposal_monitoring_frame">
            <div class="row">
        ...
        <div class="frame-container">
            ...
            <div class="bs-example frame-inner-container" style="display:none;">
                ...
                <div class="embed-responsive embed-responsive-16by9" style="height: 1019.938px;">
                    <iframe id="budget_proposal_monitoring_frame" class="embed-responsive-item" src=""></iframe>
                </div>
            </div>
        </div>
    </div>
